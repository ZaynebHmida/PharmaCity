...
?>             
 ...
 <?php
        ...
        $id=$_GET['id'];
$sql="select * from lignecmd L,medicament M where L.idC='$id' and M.id_med=L.idmed";
$ligne=$con->query($sql);
$total=0;
while($l=$ligne->fetch_assoc()){
                 echo'<tr class="info">
                    <td>'.$l['nom_med'].'</td>
                       <td>'.$l['qt'].'</td>
                    ...
                    <td><a href="modif_client.php?id='.$l['idCl'].'"><button class="btn btn-warning icon-btn" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Modifier</button></a>
					 &nbsp;&nbsp;<a class="btn btn-danger icon-btn" href="suppr_client.php?id='.$l['idCl'].'"><i class="fa fa-fw fa-lg fa-times-circle"></i>Supprimer</a> <br><br>
					</td>
                  </tr>'; 
                   $total=$total+$l['prix']*$l['qt'];
