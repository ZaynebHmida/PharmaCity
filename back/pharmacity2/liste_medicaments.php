...
$sql="select * from medicament ORDER BY id_med DESC";
$medicaments=$con->query($sql);
while($med=$medicaments->fetch_assoc()){
                 echo'<tr class="info">
                    ...
                    <td><a href="modif_medicament.php?id='.$med['id_med'].'"><button class="btn btn-warning icon-btn" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Modifier</button></a>
           &nbsp;&nbsp;<button class="btn btn-danger icon-btn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-fw fa-lg fa-times-circle" ></i>Supprimer</button> <br><br>
          </td>
                  </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Suppression de medicament</h4>
      </div>
      <div class="modal-body">
        <p>Vous Vous vraiment supprimer ce mediacment?</p>
      </div>
      <div class="modal-footer">
              <a href="suppr_medicament.php?id='.$med['id_med'].'" class="btn btn-danger">Oui</a>
