                	...
                	<div class="row">
                    	...
                    	<div class="span8">
                            ...
                            <div class="contact_form">  
                            	<div id="note"></div>
                                <div id="fields">
								  <?php echo' <form id="ajax-contact-form" action="profil.php?id='.$id.'" method="POST">';?>
                                    <br>   
				  <?php
$sql1="select * from client where idCl='$id'";
$clients=$con->query($sql1);
while($client=$clients->fetch_assoc()){
$nom=$client['CIN'];
$nom1=$client['nomCl'];
$nom2=$client['prenomCl'];
$nom3=$client['ad'];
$nom4=$client['tel'];
$nom5=$client['mail'];
$nom6=$client['login'];
				  ...
				  ?>
										...
										<?php  echo'   <input class="form-control" name="CIN" type="text" placeholder="Enter CIN" value="'.$nom.'"  required>';?>
                                        <input class="span7" type="text" name="nom" value="" placeholder="Nom (required)" />
										<?php  echo'   <input class="form-control" name="nomCl" type="text" placeholder="Enter nomCl" value="'.$nom1.'"  required>';?>
										<input class="span7" type="text" name="prenom" value="" placeholder="Prenom (required)" />
										<?php  echo'   <input class="form-control" name="prenomCl" type="text" placeholder="Enter prenomCl" value="'.$nom2.'"  required>';?>
										<input class="span7" type="text" name="adresse" value="" placeholder="Adresse(required)" />
										<?php  echo'   <input class="form-control" name="ad" type="text" placeholder="Enter ad" value="'.$nom3.'"  required>';?>
                                        <input class="span7" type="text" name="tel" value="" placeholder="Numero Téléphone(required)" />
										<?php  echo'   <input class="form-control" name="tel" type="text" placeholder="Enter tel" value="'.$nom4.'"  required>';?>
										<input class="span7" type="text" name="email" value="" placeholder="Email(required)" />
										<?php  echo'   <input class="form-control" name="mail" type="text" placeholder="Enter mail" value="'.$nom5.'"  required>';?>
										<input class="span7" type="text" name="Login" value="" placeholder="Login (required)" />
										<?php  echo'   <input class="form-control" name="login" type="text" placeholder="Enter login" value="'.$nom6.'"  required>';?>
