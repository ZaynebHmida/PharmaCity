    ...
    for($i=1;$i<=strlen($pw);$i++){
        ...
        $p=$p."*";
                 ...
                 <td>'.$admin['idP'].'</td>
                    ...
                    <td><a href="modif_admin.php?id='.$admin['idP'].'"><button class="btn btn-warning icon-btn" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Modifier</button></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Suppression administrateur</h4>
      </div>
      <div class="modal-body">
        <p>Vous Vous vraiment supprimer cet administrateur?</p>
      </div>
      <div class="modal-footer">
              <a href="suppr_admin.php?id='.$admin['idP'].'" class="btn btn-danger">Oui</a>
