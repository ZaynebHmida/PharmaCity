...
public class DetailsMedicament extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = (TextView)findViewById(R.id.t1);
        nom = (TextView)findViewById(R.id.t2);
        prix = (TextView)findViewById(R.id.t4);
        lib = (TextView)findViewById(R.id.t3);
        form = (TextView)findViewById(R.id.t5);
        img = (ImageView)findViewById(R.id.imageView2);
        img.setImageBitmap(Recherche.img_med);
    ...
    private void getDetailsMedicament() {
        class PostAsync extends AsyncTask<String, String, JSONObject> {
            ...
            protected void onPreExecute() {
                pDialog = new ProgressDialog(DetailsMedicament.this);
            ...
            protected JSONObject doInBackground(String... args) {
                try {
                    ...
                    params.add(new BasicNameValuePair("IDD", Recherche.medicament_choisit));
