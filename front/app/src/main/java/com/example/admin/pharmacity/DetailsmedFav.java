...
public class DetailsmedFav extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailsmed_fav);
        ref = (TextView)findViewById(R.id.t16);
        nom = (TextView)findViewById(R.id.t18);
        prix = (TextView)findViewById(R.id.t22);
        lib = (TextView)findViewById(R.id.t20);
        form = (TextView)findViewById(R.id.t24);
        img = (ImageView)findViewById(R.id.imageView3);
        img.setImageBitmap(Favoris.img_medfav);
    ...
    private void getDetailsMedicament() {
        class PostAsync extends AsyncTask<String, String, JSONObject> {
            ...
            protected void onPreExecute() {
                pDialog = new ProgressDialog(DetailsmedFav.this);
            ...
            protected JSONObject doInBackground(String... args) {
                try {
                    ...
                    params.add(new BasicNameValuePair("IDD", Favoris.mled_choist));
